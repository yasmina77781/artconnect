  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100vh', overflow: 'hidden', background: 'white' }}>
      ...
      <div style={{ paddingTop: '32px', paddingBottom: '16px' }}>
        <h1 style={{ fontSize: '2rem', fontFamily: "'Abril Fatface', serif", color: 'black', margin: 0 }}>Artworks</h1>
      </div>
      ...
      <div style={{
        ...
        gap: '20px',
        background: 'rgba(216, 211, 211, 0.6)',
        padding: '12px',
        borderRadius: '20px',
        alignItems: 'center',
        zIndex: 30
